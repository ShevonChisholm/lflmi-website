...
const visitors = [
  { id: 1, name: "Adaeze Okonkwo", initials: "AO", email: "adaeze.o@gmail.com", phone: "+234 803 456 7890", address: "Garki, Abuja", date: "Jun 22, 2025", service: "10:30 AM", status: "New", source: "Friend Referral", notes: "First-time visitor, came with the Chukwu family. Very engaged during worship.", followUp: false },
  { id: 2, name: "Michael Osei", initials: "MO", email: "m.osei@outlook.com", phone: "+234 806 234 5678", address: "Wuse 2, Abuja", date: "Jun 22, 2025", service: "8:00 AM", status: "Follow-up", source: "Social Media", notes: "Had a great conversation after service. Interested in joining a life group.", followUp: true },
  { id: 3, name: "Fatima Al-Hassan", initials: "FA", email: "fatima.ah@yahoo.com", phone: "+234 809 876 5432", address: "Maitama, Abuja", date: "Jun 15, 2025", service: "10:30 AM", status: "Returning", source: "Website", notes: "Third visit this month. Expressed interest in Women's Fellowship.", followUp: false },
  { id: 4, name: "James Amaka", initials: "JA", email: "james.amaka@gmail.com", phone: "+234 701 234 5678", address: "Lugbe, Abuja", date: "Jun 15, 2025", service: "8:00 AM", status: "New", source: "Walk-in", notes: "Came alone, seemed reserved. Greeter gave welcome packet.", followUp: true },
  { id: 5, name: "Grace Mensah", initials: "GM", email: "grace.m@gmail.com", phone: "+234 812 345 6789", address: "Karu, Abuja", date: "Jun 8, 2025", service: "10:30 AM", status: "New", source: "Flyer/Poster", notes: "Arrived late but stayed for the full service and connect lunch.", followUp: false },
  { id: 6, name: "Chidi Nwosu", initials: "CN", email: "chidi.n@gmail.com", phone: "+234 816 789 0123", address: "Asokoro, Abuja", date: "Jun 8, 2025", service: "8:00 AM", status: "Returning", source: "Friend Referral", notes: "Second visit. Picked up membership class brochure.", followUp: false },
  { id: 7, name: "Amina Bello", initials: "AB", email: "amina.b@gmail.com", phone: "+234 805 432 1098", address: "Gwarinpa, Abuja", date: "Jun 1, 2025", service: "10:30 AM", status: "Follow-up", source: "Social Media", notes: "Very responsive to the message. Left contact for pastoral follow-up.", followUp: true },
  { id: 8, name: "Peter Oluwaseun", initials: "PO", email: "peter.o@yahoo.com", phone: "+234 808 654 3210", address: "Kubwa, Abuja", date: "Jun 1, 2025", service: "10:30 AM", status: "New", source: "Walk-in", notes: "Recently relocated from Lagos. Looking for a church home.", followUp: false },
];
