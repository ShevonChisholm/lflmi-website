...
export default function Sermons() {
  ...
  return <div className="p-5 lg:p-7">
    ...
    {previewing && <AdminSermonPreview sermon={previewing} onClose={()=>setPreviewing(null)}/>}
  </div>;
}
